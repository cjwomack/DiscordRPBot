...
It is intentionally simple and meant to assist discord driven Roleplaying games, without attempting to do too much.
...
1. Command List
    ...
    All commands use the ! prefix.  Arguments are shown with brackets [].  Do not include the bracket in your commands.
        ...
        Chance Commands:
                ...
                !roll [multiplier]d[dice sides]
                      Rolls a dice of user specified sides.  e.g. !roll 2d20 to roll 2 d20 or !roll d20 for a single d20.
